 ...
 *
 * To be implemented in PointOfSaleModel
 */
public interface PointOfSaleModelInterface {
     ...
     */
    String insertSale(ArrayList<String> addedItems, String ccNumber, String ccName, boolean isCreditCardPayment, String orderNumber);
